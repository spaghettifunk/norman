...
import (
	...
	"github.com/spaghettifunk/norman/pkg/containers"
	"github.com/spaghettifunk/norman/pkg/containers/hashset"
...
func NewHashset[K comparable](cap uint64, equals containers.EqualsFn[K], hash containers.HashFn[K], in ...K) Set[K] {
